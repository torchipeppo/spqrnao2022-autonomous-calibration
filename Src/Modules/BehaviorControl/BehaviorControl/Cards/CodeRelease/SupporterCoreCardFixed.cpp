...
class SupporterCoreCardFixed : public SupporterCoreCardFixedBase
{
  ...
  option
  {
    theActivitySkill(BehaviorStatus::supporterCoreCardFixed);
    initial_state(start)
    {
      transition
      {
...
MAKE_CARD(SupporterCoreCardFixed);