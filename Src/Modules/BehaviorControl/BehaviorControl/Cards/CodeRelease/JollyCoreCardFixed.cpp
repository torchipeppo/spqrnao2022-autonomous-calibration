...
class JollyCoreCardFixed : public JollyCoreCardFixedBase
{
  ...
  bool preconditions() const override
  {
    ...
    bool isStriker_defender =position.x()<0;//strikerPosition.x()<0&&position.x()<0;
    return false;
  ...
  option
  {
    theActivitySkill(BehaviorStatus::jollyCoreCardFixed);
    initial_state(start)
    {
      transition
      {
        ...
        #endif
          //std::cout <<" Fixed jolly card" << std::endl;
          goto turnToPose;               
      }
      action
      {
...
//            }
        ...
        action
        {
            ...
            if((theLibCheck.glob2Rel(theLibCheck.jollyPosition.x(),
                ...
                theWalkToTargetPathPlannerSkill(Pose2f(50.f, 80.0f, 80.0f), Pose2f(theLibCheck.jollyPosition.x(),
                                                              theLibCheck.jollyPosition.y()));
                //Arms back
