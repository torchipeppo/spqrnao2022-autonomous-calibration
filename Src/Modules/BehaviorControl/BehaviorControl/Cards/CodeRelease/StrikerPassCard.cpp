/**
 * @file StrikerPassCard.cpp
 *
 * Card to approach the ball and pass.
 *
...
class StrikerPassCard : public StrikerPassCardBase
{
  ...
  Vector2f chooseTarget() const {
    ...
    Vector2f target = jolly.theRobotPose.translation + Vector2f(350, -jolly_y_sign*350);
  ...
  bool preconditions() const override
  {
    /*int jolly_index = getJollyIndex();
    if (jolly_index < 0) {
      std::cout << "NO JOLLY" << std::endl;
      return false;
    }
    Teammate jolly = theTeamData.teammates.at(jolly_index);
    return jolly.thePassShare.readyReceive && jolly.theRobotPose.translation.x() > theRobotPose.translation.x()+200;*/
    return thePassShare.readyPass;
  }
  ...
  bool postconditions() const override
  {
    ...
    Teammate jolly = theTeamData.teammates.at(jolly_index);
    return !jolly.thePassShare.readyReceive || jolly.theRobotPose.translation.x() < theRobotPose.translation.x();*/
    return !thePassShare.readyPass;
  }
  ...
  option
  {
    ...
    initial_state(start)
    {
      std::cout<<"pass2021: start"<<std::endl;
      transition
      {
