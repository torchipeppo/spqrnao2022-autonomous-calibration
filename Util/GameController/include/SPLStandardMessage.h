 ...
 * 34 byte are the data needed by the standard message, so, the one put below before the data vector
...
// END OF THE STANDARD PART. THE STANDARD PART HAS TO BE LONG 34 bytes THEN we have a max of 474 bytes.  
